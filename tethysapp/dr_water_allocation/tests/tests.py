...
# from ..app import DrWaterAllocation
    ...
    4. Enter tethys test command.
       ...
       See below for specific examples
        ...
        To run all tests across this app:
            Test command: "tethys test -f tethys_apps.tethysapp.dr_water_allocation"

        To run all tests in this file:
            Test command: "tethys test -f tethys_apps.tethysapp.dr_water_allocation.tests.tests"

        To run tests in the DrWaterAllocationTestCase class:
            Test command: "tethys test -f tethys_apps.tethysapp.dr_water_allocation.tests.tests.DrWaterAllocationTestCase"

        To run only the test_if_tethys_platform_is_great function in the DrWaterAllocationTestCase class:
            Test command: "tethys test -f tethys_apps.tethysapp.dr_water_allocation.tests.tests.DrWaterAllocationTestCase.test_if_tethys_platform_is_great"
...
class DrWaterAllocationTestCase(TethysTestCase):
    """
    ...
    def set_up(self):
        ...
        test database creation function here, like so:
            ...
            self.create_test_persistent_stores_for_app(DrWaterAllocation)
    ...
    def tear_down(self):
        ...
        stores, you should call the test database destruction function from here, like so:
            ...
            self.destroy_test_persistent_stores_for_app(DrWaterAllocation)
    ...
    def test_home_controller(self):
        ...
        response = c.get('/apps/dr-water-allocation/')  # The final '/' is essential for all pages/controllers
